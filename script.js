const cards = [
  ...
  {permalink: 'rocket-news', img: "./assets/banner-rocketnews.webp", title: 'Desafio "RocketNews"', description: 'Desenvolva uma página web simples utilizando HTML e CSS que servirá no futuro para captação de leads ou inscrição em newsletter.', badges: {levelText: "Iniciante", levelImage: "./assets/iniciante.svg", tags: ['HTML', "CSS"]}},
  ...
  {permalink: 'rocket-blog', img: "./assets/banner-rocketblog.webp", title: 'Desafio "RocketBlog"', description: 'Neste desafio você irá desenvolver uma homepage para um blog.', badges: {levelText: "Intermediário", levelImage: "./assets/intermediario.svg", tags: ['HTML', 'CSS']}},
  {permalink: 'rocket-coffee', img: "./assets/banner-rocketcoffee.webp", title: 'Desafio "RocketCoffee"', description: 'Neste desafio você deverá desenvolver uma homepage para uma marca de café.', badges: {levelText: "Intermediário", levelImage: "./assets/intermediario.svg", tags: ['HTML', 'CSS', 'Javascript']}},
  {permalink: 'rocket-flix', img: "./assets/banner-rocketflix.webp", title: 'Desafio "RocketFlix"', description: 'Neste desafio você deverá utilizar a API do themoviedb.org para exibir um filme aleatório sempre que clicar em Encontrar Filme.', badges: {levelText: "Avançado", levelImage: "./assets/avancado.svg", tags: ['HTML', 'CSS', 'Javascript']}},
